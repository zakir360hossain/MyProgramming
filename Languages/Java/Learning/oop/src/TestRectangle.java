public class TestRectangle {
    public static void main(String[] args) {
       ...
       System.out.println("Big Rectangle: "+ bigRectangle2);
       ...
       System.out.println("\nSmall Rectangle: "+ smallRectangle2);
       ...
       otherRectangle2.isValidRectangle();
        ...
        System.out.println("\nOther Rectangle again, after modification: "+ otherRectangle2);

        otherRectangle2.moveRectangle(2, 3);
        System.out.println("\nOther Rectangle again, after translation: "+ otherRectangle2);
