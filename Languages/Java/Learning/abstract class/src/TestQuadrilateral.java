 ...
 * Feb 18, 2020
 * This is the main method for the abstract parent Quadrilateral class.
 * It creates instances for every child classes that are extended to the Quadrilateral.
 */
public class TestQuadrilateral {

    public static void main(String[] args) {
        // Objects for Parallelogram
        Parallelogram para1 = new Parallelogram("Parallelogram", 8, 15, 12);
        Parallelogram para2 = new Parallelogram("Parallelogram", 20, 30, 24);
        ...
        if (para1.compareTo(para2) ==1){
            System.out.println("The following Parallelogram is the bigger out of the two: "+para1+ "\n");
        }
        else if(para1.compareTo(para2)==-1){
             System.out.println("The following Parallelogram is the bigger out of the two:"+para2+"\n");
        ...
        // Objects for Trapezoid
        Trapezoid trap1 = new Trapezoid("Trapezoid", 6, 14, 12, 10);
        Trapezoid trap2 = new Trapezoid("Trapezoid", 20, 23, 25, 22);
        System.out.println("\n\n===========Trapezoids============");
