 ...
 * Feb 11, 2020
 * This BirthdayBalloon is a child class of the SquareBalloon class, which itself is a child class of the parent class
 * Balloon. It simply constructs a parameterized constructor; some of the parameters are than parameterized to the
 * generic parameters that the superclass Balloon tkake, through the use of super(). And it contains a toString that
