 ...
 * Feb 26, 2020
 * This main class is for testing the Student and its child classes, and the Team class.
 */
public class TestStudent {
    public static void main(String[] args) {

        // Instantiation of Student for two objects
        Student student1 = new Student("Ethan Chedda", 8);
        Student student2 = new Student("Julia Lee", 7);
        System.out.println("\n==============Regular Students=============");
        System.out.println(student1 + "\n"+student2);

        // Instantiation of StudentAthlete for two objects
        ...
        // Instantiation of GraduateStudent for two objects
