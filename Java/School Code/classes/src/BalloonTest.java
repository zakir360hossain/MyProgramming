 ...
 * Feb 11, 2020
 * This is the main program to instantiate objects for all child classes that are extended to
 * the parent, or the abstract class Balloon.
 */
...
//        Create rndBalloon objects
        ...
        CelebrateBalloon celebrateBalloon1 = new CelebrateBalloon("RED", 0.99, 4, 5,
                "Football", "Go Team");
