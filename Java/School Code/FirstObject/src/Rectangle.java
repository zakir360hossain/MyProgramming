...
public class Rectangle {
    ...
    public Rectangle(int y_top, int y_bottom, int x_left, int x_right){
        // Parameterized
        top = y_top;
        bottom = y_bottom;
        left = x_left;
    ...
    public Rectangle moveRectangle(int rightUnits, int upUnits){
        ...
        int newLeft = left;
        int newRight = right;
        Rectangle TotherRectangle = new Rectangle(newTop, newBottom, newLeft, newRight);
        return TotherRectangle;
    }

    public Rectangle rotateNinety(){
       int temp1 = calcWidth();
       int temp2 = calcLength();
        ...
        int newLeft = left;
        int newRight = right;
        Rectangle rotatedRectangle = new Rectangle(newTop, bottom, newLeft, newRight);
