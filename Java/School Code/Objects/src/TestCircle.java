 ...
 * October 16, 2019
 * 			This main program tests the Circle Circle object of the class Circle. Specifically, it tests
...
public class TestCircle {
    public static void main(String[] args) {
        ...
        System.out.println("Circle 1 Center: ("+ circle1.getH()+ ", "+ circle1.getK() +")");
        System.out.println("Circle 1 Center: ("+ circle2.getH()+ ", "+ circle2.getK() +")");

        // Testing Mutator methods
        circle1.setH(6);
        circle1.setK(8);
        circle1.setRadius(16);
        System.out.println("Circle 1 equation (after modified): ");
        System.out.println(circle1 +"\n");
       ...
       Circle circle3 =  circle2.translation(2, 4);
        System.out.println("Circle (translated circle2): " +circle3);
