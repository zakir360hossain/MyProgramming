 ...
 * Feb 22, 2020
 * This is the main class to test the Edible interface with many impementations from this interface.
 */
public class RunEdible {
    public static void main(String[] args) {
        ...
        Cereal bowl = new Cereal("Breakfast Food", 110, 50, 10);
        ...
        System.out.println("\nTotal Breakfast Calories:    "+breakfastCalories+ "\n\n");
        ...
        Pie creamPie = new Pie("Dessert", "Banana", 670, 200);
        ...
        System.out.println("\nTotal Lunch Calories:    "+lunchCalories + "\n\n");
        ...
        System.out.println("\nTotal Lunch Calories:    "+dinnerCalories+"\n\n");
