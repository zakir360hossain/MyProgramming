class Employee:
    """This class is about employee directory"""
    raise_percentage = 1.4
    ...
    def apply_raise(self):  # Class Variables
        self.pay = int(self.pay * Employee.raise_percentage)  # self.raise_percentage is also valid
...
print((employee1.raise_percentage - 1) * employee2.pay)  # Delta in pay
print(employee1.pay)
